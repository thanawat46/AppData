    ...
    return WillPopScope(
      ...
      child: Scaffold(
        body: Container(
          ...
          child: Column(
            children: [const Padding(padding: EdgeInsets.only(top: 125, bottom: 20),
                            ...
                            SizedBox(
                              ...
                              child: ElevatedButton(
                                ...
                                onPressed: () {
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(builder: (context) => Income_year()),
                                  );
                                },
                                child: const Row(
                            ...
                            SizedBox(
                              ...
                              child: ElevatedButton(
                                ...
                                onPressed: () {
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(builder: (context) => CheckQueuePage()),
                                  );
                                },
                                child: const Row(
